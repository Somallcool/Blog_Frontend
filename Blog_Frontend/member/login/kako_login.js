...
const KAKAO_AUTH_START_ENDPOINT =
  "https://backward-plaster-pleading.ngrok-free.dev/api/v1/oauth/kakao/url";
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result && result.kakaoAuthUrl) {
          ...
          // redirect_uri(https://backward-plaster-pleading.ngrok-free.dev/login/oauth2/code/kakao) 정보가 포함됨
